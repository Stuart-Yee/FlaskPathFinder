...
"from flask_app.controllers import #TODO controllers go here\nfrom flask_app import app\nif __name__==\"__main__\":\n\tapp.run(debug=True)"
    ...
    print(COLOR["GREEN"], "Creating", "flask_app folder", COLOR["ENDC"])
    Path("flask_app").mkdir()
    os.chdir("flask_app")

    #creating the folders inside the app folder accorindg to MVC design
    print(COLOR["GREEN"], "Creating", "flask_app/config folder", COLOR["ENDC"])
    Path("config").mkdir()
    print(COLOR["GREEN"], "Creating", "flask_app/controllers folder", COLOR["ENDC"])
    Path("controllers").mkdir()
    print(COLOR["GREEN"], "Creating", "flask_app/models folder", COLOR["ENDC"])
    Path("models").mkdir()
    print(COLOR["GREEN"], "Creating", "flask_app/static folder", COLOR["ENDC"])
    Path("static").mkdir()
    print(COLOR["GREEN"], "Creating", "flask_app folder/templates", COLOR["ENDC"])
...
def test_mode(app_name="flask_app"):
    #check file paths
